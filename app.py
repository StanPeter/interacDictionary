...
def translator(word):
    ...
    while True:
        if w in data:
            ...
            answer = input(f"Your word wasn't found, did you mean '{similar_word}' instead?  y / n \n")
            if answer == "y":
...
def user_interface():
    print("Hello, my name is Bob and I will be your helper throughout this translator")
    ...
    while True:
        ...
        word = input("Please tell me the word you wish to find, to end the programme press 'q'   \n\n")
        if word == "q":
